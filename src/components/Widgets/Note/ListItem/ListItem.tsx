...
import { ListItemModel } from "../Note";

interface ListItemProps {
    readonly id: string;
    readonly item: ListItemModel;
    readonly handleUpdateItem: (id: string, newText: string, isCompleted: boolean) => void;
    readonly handleDeleteItem: (id: string) => void;
    readonly handleAddListItem: (id: string) => void;
    readonly focusedItemId: string | null;
}

export default function ListItem({id, item, handleUpdateItem, handleDeleteItem, handleAddListItem, focusedItemId}: ListItemProps) {
